...
struct Teachers {
    struct Delaney {
        static let name = "Mr. Delaney \n"
        static let ccpaEmail = "delaney@ccpaedu.com"
        static let ousdEmail = "michael.delaney@ousd.org"
        static let img = #imageLiteral(resourceName: "Delaney.JPG")
    }
    ...
    struct Duenas {
        static let name = "Samuel \"Sammy\" Dueñas"
        static let ccpaEmail =  "duenas@ccpaedu.com"
        static let ousdEmail = "samuel.duenasjr@ousd.org"
        static let img = #imageLiteral(resourceName: "Duenas.JPG")
    }
    ...
    struct Ibarra {
        static let name = "Mrs. Ibarra"
        static let ccpaEmail = "ibarra@ccpaedu.com"
        static let ousdEmail = "carina.ibarra@ousd.org"
        static let img = #imageLiteral(resourceName: "Ibarra.JPG")
    }
    ...
    struct Korschun {
        static let name = "Ms. Korschun"
        static let ccpaEmail = "korschun@ccpaedu.com"
        static let ousdEmail = "rachel.korschun@ousd.org"
        static let img = #imageLiteral(resourceName: "Korschun.JPG")
    }
    ...
    struct Mack {
        static let name = "Mr. Mack"
        static let ccpaEmail = "mack@ccpaedu.com"
        static let ousdEmail = "tyjun.mack@ousd.org"
        static let img = #imageLiteral(resourceName: "Mack.JPG")
    }
